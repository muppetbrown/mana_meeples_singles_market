 ...
 */
router.get('/variations/filters', async (req, res) => {
  try {
 ...
 */
router.get('/variations/metadata/:setId', async (req, res) => {
  try {
 ...
 */
router.get('/variations/metadata/game/:gameId', async (req, res) => {
  try {
 ...
 */
router.get('/variations/stats/:setId', async (req, res) => {
  try {
    const { setId } = req.params;
 ...
 */
router.get('/variations/stats/game/:gameId', async (req, res) => {
  try {
    const { gameId } = req.params;
 ...
 * Admin only endpoint
 */
router.post('/admin/variations/analyze', async (req, res) => {
  try {
 ...
 * Admin only endpoint
 */
router.post('/admin/variations/refresh', async (req, res) => {
  try {
    await variationService.refreshVariationFilters();
